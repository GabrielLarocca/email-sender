...
mongoose.connect(config.database, { keepAlive: true, reconnectTries: Number.MAX_VALUE });
...
async function start() {
	...
	if (rootExists) {
		...
		if (data) console.log("Registered user root");
		else console.log("Error when registering root", err);
	}
};
